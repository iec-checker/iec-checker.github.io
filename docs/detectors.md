...
iec-checker ships with **28 detectors** out of the box. Each detector has a stable rule ID that appears in the analyzer's output.
...
| 10 | [PLCOPEN-CP17](./detectors/PLCOPEN-CP17.md)    | Usage of parameters shall match their declaration mode               |
| 11 | [PLCOPEN-CP25](./detectors/PLCOPEN-CP25.md)    | Data types conversion should be explicit                             |
| 12 | [PLCOPEN-CP26](./detectors/PLCOPEN-CP26.md)    | A global variable may be written only by one PROGRAM                 |
| 13 | [PLCOPEN-CP28](./detectors/PLCOPEN-CP28.md)    | Time and physical measures comparison shall not be equality or inequality |
| 14 | [PLCOPEN-L10](./detectors/PLCOPEN-L10.md)      | Usage of CONTINUE and EXIT instruction should be avoided             |
| 15 | [PLCOPEN-L13](./detectors/PLCOPEN-L13.md)      | FOR loop variable should not be used outside the FOR loop            |
| 16 | [PLCOPEN-L17](./detectors/PLCOPEN-L17.md)      | Each IF instruction should have an ELSE clause                       |
| 17 | [PLCOPEN-L22](./detectors/PLCOPEN-L22.md)      | Loop variables should not be modified inside a FOR loop              |
| 18 | [PLCOPEN-N1](./detectors/PLCOPEN-N1.md)        | Avoid physical addresses                                             |
| 19 | [PLCOPEN-N2](./detectors/PLCOPEN-N2.md)        | Define type prefixes for variables                                   |
| 20 | [PLCOPEN-N3](./detectors/PLCOPEN-N3.md)        | Define the names to avoid                                            |
| 21 | [PLCOPEN-N4](./detectors/PLCOPEN-N4.md)        | Define the use of case (capitals)                                    |
| 22 | [PLCOPEN-N5](./detectors/PLCOPEN-N5.md)        | Local names shall not shadow global names                            |
| 23 | [PLCOPEN-N6](./detectors/PLCOPEN-N6.md)        | Define an acceptable name length                                     |
| 24 | [PLCOPEN-N8](./detectors/PLCOPEN-N8.md)        | Define the acceptable character set                                  |
| 25 | [PLCOPEN-N9](./detectors/PLCOPEN-N9.md)        | Different element types should not bear the same name                |
| 26 | [PLCOPEN-N10](./detectors/PLCOPEN-N10.md)      | Define name prefixes for user defined types                          |
